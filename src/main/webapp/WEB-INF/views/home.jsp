...
<body>
 ...
 <h2 style=" color: white; padding-right: 35px;">Cultive</h2>
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <ul class="nav navbar-nav navbar-right sb">
		...
		<div  class="carousel slide crslide" data-ride="carousel">
		  <div class="carousel-inner">
		    <div class="carousel-item active">
		      <img class="d-block w-100" src="<c:url value="/resources/images/images1.jpg" />" alt="First slide">
		    </div>
		    <div class="carousel-item">
		      <img class="d-block w-100" src="<c:url value="/resources/images/images2.jpg" />" alt="Second slide">
		    </div>
		    <div class="carousel-item">
		      <img class="d-block w-100" src="<c:url value="/resources/images/images3.jpg" />" alt="Third slide">
		    </div>
		  </div>
		</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
        	    ...
        	    <button type="button" class="btn btn-sm btn-success">Getting Started</button>
...
<section class="py-5 bg-1 text-white">
    <div class="container py-5">
	   <div class="row">
	       <div class="col-md-4">
        	    <h2>BEST APP</h2>
        	  <p>Lorem ipsum dolor sit amet conse ctetur adipisicing elit sed do eiusm od tempor incididunt ut labore et dolore magna aliqua.
</p>
            </div>
            <div class="col-md-3">
        	    <b>Quick Links</b>
